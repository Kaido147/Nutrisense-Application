...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color navy = Color(0xFF24376B);
    const Color bg = Color(0xFFF3F0EC);
    const Color cardColor = Colors.white;
    const Color gold = Color(0xFFD6B66E);
    const Color blue = Color(0xFF6A9CF6);
    const Color green = Color(0xFF22C55E);
    const Color textDark = Color(0xFF1F2A44);
